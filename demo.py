""" This script performs the inference phase of ACANet. The user can decide whether to visualise the predictions as overlays, save predictions or save the visualisation."""
...
from dataset.occluded_affordance_dataset import OccludedAffordanceSegmentationDataset
